...
var _SearchControl = __webpack_require__(2);
...
var _AutoFlyout = __webpack_require__(3);

var _AutoFlyout2 = _interopRequireDefault(_AutoFlyout);
...
var SearchControl = function (_React$Component) {
  ...
  function SearchControl(props) {
    ...
    _this.setSearchKeyState = function (event) {
      _this.setState({ searchKey: event.target.innerText });
      _this.handleChange(event);
    };

    _this.filterBasedOnKey = function (searchKey) {
      ...
      _this.props.setAppStateCallback({ filteredProducts: filteredProducts });
    };
      ...
      if (!this.props.catalog.products.length) {
        $.ajax({
          ...
          success: function success(result) {
            ...
            _this2.props.setAppStateCallback({ catalog: catalog });
...
var AutoFlyout = function (_React$Component) {
  ...
  function AutoFlyout(props) {
    _classCallCheck(this, AutoFlyout);

    var _this = _possibleConstructorReturn(this, (AutoFlyout.__proto__ || Object.getPrototypeOf(AutoFlyout)).call(this, props));
    ...
    _this.handleClick = function (event) {
      _this.props.setSearchKeyState(event);
      _this.hideFlyout();
      event.preventDefault();
    };
